...
(
    ...
    0.00,
    90000.00,
    'Khách hàng đổi ý muốn đổi món khác',
    NULL,
    '2026-09-01 10:15:00',
    '2026-09-01 10:20:00'
),
...
(
    ...
    30000.00,
    'RESOLVED',
    'Admin đã kiểm tra chương trình đồng tài trợ và chấp thuận bồi hoàn thêm 30.000 VNĐ.',
    '2026-08-01 14:00:00',
    '2026-08-02 09:30:00'
)
ON DUPLICATE KEY UPDATE
...
(
    ...
    'REJECTED',
    85000000.00,
    'Doanh thu tháng chưa đạt ngưỡng tối thiểu 100.000.000 VNĐ theo tiêu chuẩn quy định.',
    '2026-08-15 11:00:00',
    '2026-08-16 14:00:00'
)
ON DUPLICATE KEY UPDATE
