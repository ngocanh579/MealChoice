...
-- Thêm Chi tiết món ăn vào các đơn hàng (Hiển thị Top Món Bán Chạy)
-- Thêm chi tiết món ăn trực tiếp theo order_id (1, 2, 3, 4)
-- 1. Xóa dữ liệu cũ của merchant này
-- 1. Xóa dữ liệu cũ
...
-- 2. Thêm đơn hàng thực tế (từ 170.000 đ đến 420.000 đ/đơn)
...
(102, 'MC-20260218-02', '00000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', 'Nguyễn Văn Anh', '0900000002', 'Hà Nội', 'COMPLETED', 220000, 220000, '2026-02-18 11:30:00'),
(103, 'MC-20260310-03', '00000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', 'Nguyễn Văn Anh', '0900000002', 'Hà Nội', 'COMPLETED', 175000, 175000, '2026-03-10 12:15:00'),
...
(105, 'MC-20260520-05', '00000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', 'Nguyễn Văn Anh', '0900000002', 'Hà Nội', 'COMPLETED', 310000, 310000, '2026-05-20 19:30:00'),
(106, 'MC-20260612-06', '00000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', 'Nguyễn Văn Anh', '0900000002', 'Hà Nội', 'COMPLETED', 270000, 270000, '2026-06-12 12:00:00'),
...
-- 3. Thêm chi tiết món ăn (số lượng 1 - 5 phần)
